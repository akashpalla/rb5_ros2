...
class MegaPiControllerNode(Node):
    def __init__(self, verbose=False, debug=False):
        ...
        self.r = 0.03016 # radius of the wheel
        self.lx = 0.06747 # half of the distance between front wheel and back wheel
        self.ly = 0.05635 # half of the distance between left wheel and right wheel
