...
//         // tf_gm.transform.translation.x = poses[i].t->data[0];
//         // tf_gm.transform.translation.y = poses[i].t->data[2];
//         // tf_gm.transform.translation.z = poses[i].t->data[1];
...
//         // tf_gm.transform.rotation.x = q.x();
//         // tf_gm.transform.rotation.y = q.z();
//         // tf_gm.transform.rotation.z = q.y();
//         // tf_gm.transform.rotation.w = q.w();
...
//       // msg.pose.position.x = poses[i].t->data[0];
//       //   msg.pose.position.y = poses[i].t->data[2];
//       //   msg.pose.position.z = poses[i].t->data[1];
