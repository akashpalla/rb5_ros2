...
class RobotStateEstimator(Node):
    def __init__(self):
        ...
        self.apriltag_world_poses = {
            'marker_4': (1.34, 0.0, 0.0, 0.5, -0.5, 0.5, -0.5), # (x,y,z, qual_x, qual_y, qual_z, qual_w)
            'marker_5': (-0.5, 2.0, 0.0, -0.5, -0.5, 0.5, 0.5),
        }
...
def main(args=None):
    ...
    waypoint = np.array([[1.0,0.0,0.0],  [1.0,2.0,np.pi] ]) #, 
                        #  [0.3,0.0,0.0]
    # ])
    ...
    # init pid controller
    pid = PIDcontroller(0.07,0.00,0.2)
